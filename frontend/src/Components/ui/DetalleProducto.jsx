...
;
    ...
    const fetchAvialabeProductsForDates = async (id) => {
        try {
            const dataJSON = await fetch(`http://localhost:8080/api/v1/productos/${id}/available-dates`);
            ...
            <div className="detalle-producto-container">
                ...
                <div className='reservarProducto-conatiner'>
                    <div className='reservarProducto-fechasDisponibles-container'>
                        <h3 className="reservarProducto-fechasDisponibles-title">Fechas Disponibles</h3>
                    ...
                    <div className='reservarProducto-btn-container'>
                        <button className='reservar-btn' onClick={reservar}>Realizar Reserva</button>
                    </div>
                </div>
                <div className="detalle-producto-info-container">
                    <div className="detalle-producto-description-container">
                        <p className="detalle-producto-description-text">
                            <i className="socialM-icon bi-geo-alt adress-icon"></i>{producto.cityDto.state}, {producto.cityDto.name}, {address}
                        </p>
                    </div>
                    <div className='detalle-producto-info-stars-conatiner'>
                        <p className='detalle-producto-info-stars-text'>{mapValueToRange(producto.rate)}</p>
